  ...
  return (
    <div className="screen-container animate-slide-up settings-screen">
      ...
      <div className="settings-content glass-panel" style={{ overflowY: 'auto', padding: '24px' }}>
        ...
        <div className="settings-group" style={{ marginTop: '32px', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '24px', display: 'flex', gap: '16px' }}>
          <button className="btn-secondary" onClick={handleReset} style={{ flex: 1, display: 'flex', justifyContent: 'center', gap: '8px' }}>
            <RotateCcw size={18} />
            Reset Defaults
          </button>
          <button className="btn-secondary" onClick={handleOpenLogs} style={{ flex: 1, display: 'flex', justifyContent: 'center', gap: '8px' }}>
            <FolderOpen size={18} />
            Open Logs
          </button>
        </div>
